...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.tOXA.Ko'] ?? self::get_ServiceLocator_TOXA_KoService($container)), ($container->privates['.service_locator.Kq6nt_2'] ?? $container->load('get_ServiceLocator_Kq6nt2Service')), ['api' => [($container->privates['debug.security.authenticator.jwt.api'] ?? $container->load('getDebug_Security_Authenticator_Jwt_ApiService'))], 'login' => [($container->privates['debug.security.authenticator.json_login.login'] ?? $container->load('getDebug_Security_Authenticator_JsonLogin_LoginService'))]], false);
